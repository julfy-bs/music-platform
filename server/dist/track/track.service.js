...
let TrackService = class TrackService {
    ...
    async create(dto, picture, audio) {
        const audioPath = this.fileService.createFile(file_service_2.FileType.AUDIO, audio);
        const picturePath = this.fileService.createFile(file_service_2.FileType.IMAGE, picture);
